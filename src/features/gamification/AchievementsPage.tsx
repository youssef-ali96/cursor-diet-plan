  ...
  return (
    <AppLayout>
      ...
      <PageContent>
        ...
        <Card glow className="p-8">
          <div className="flex items-center gap-5">
            <div className="relative shrink-0">
              <CircularProgress value={xpPercent} size={90} strokeWidth={7} color="#C8FF00">
                <div className="text-center">
                  ...
                  <p className="text-[9px] text-[#B0B0BC] font-semibold uppercase">LVL</p>
                </div>
              </CircularProgress>
            </div>
            <div className="flex-1">
              ...
              <ProgressBar value={xpPercent} color="#C8FF00" height={8} className="mt-6" />
            </div>
          </div>

          <div className="grid grid-cols-3 gap-6 mt-6 pt-6 border-t border-[#2A2A30]">
            {[
              ...
              <div key={label} className="text-center">
                ...
                <p className="text-sm font-medium text-[#9A9AAC] mt-6">{label}</p>
              </div>
            ))}
          </div>
        </Card>
        ...
        {unlocked.length > 0 && (
          <div>
            <h2 className="text-sm font-bold text-[#8A8A9C] uppercase tracking-widest mb-5">Unlocked ({unlocked.length})</h2>
        ...
        {locked.length > 0 && (
          <div>
            <h2 className="text-sm font-bold text-[#8A8A9C] uppercase tracking-widest mb-5">In Progress ({locked.length})</h2>
            <div className="grid sm:grid-cols-2 gap-6">
...
function AchievementCard({
  ...
  return (
    <Card className={cn('p-8 flex items-start gap-6', unlocked && 'border-[#C8FF00]/25')}>
      <div
        className={cn(
          'w-16 h-16 rounded-2xl flex items-center justify-center text-2xl shrink-0',
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          ...
          {unlocked && <span className="text-[#30D158] text-sm font-bold bg-[#30D158]/10 px-2 py-0.5 rounded-full">✓</span>}
        </div>
        ...
        {!unlocked && (
          <div className="mt-6">
            ...
            <ProgressBar value={pct} color="#C8FF00" height={8} />
          </div>
        )}
